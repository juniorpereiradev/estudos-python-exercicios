...
- [x] **Aula 1:** Variáveis e conversão de tipos (`str`, `int`, `float`)
- [x] **Aula 2:** Operações matemáticas básicas
- [x] **Aula 3:** Formatação de texto (`f-strings`, `\n`, `:.2f` e divisores)
- [x] **Exercícios Práticos do Nível 1:**
  - [x] Cálculo de frete e quantidade de caixas
  - [x] Simulador de rendimento e dividendos
  - [x] Divisão de pagamento de projeto freelancer
...
- [x] **Aula 1:** Condicionais simples e comparadores (`if`, `elif`, `else`, `==`, `>=`, `<=`)
  ...
  - [x] Exercício 2: Sistema de triagem por idade e IMC
- [x] **Aula 2:** Operadores lógicos (`and`, `or`, `not`)
...
Desenvolvido por **Aelson Junior**
